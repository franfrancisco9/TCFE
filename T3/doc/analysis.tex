...
\includegraphics[width=0.6\linewidth]{venv.eps} %FAZER PLOT EM OCTAVE
\label{fig:gteo1}
\end{figure}
\newpage
...
\includegraphics[width=0.6\linewidth]{vout.eps} %FAZER PLOT EM OCTAVE
\label{fig:gteo2}
\end{figure}
\newpage
...
\begin{table}[h]
    ...
    {\bf Element } & {\bf Value } \\
    \hline \hline
    Average Output Voltage [V] & !!!!!!! \\   %VALORES!!!
    \hline
    Output Voltage Ripple [V] & !!!!!!! \\
    \hline
    Merit & !!!!!!! \\  %CALCULAR MERIT NO OCTAVE OU ENTÃO PÔR O MÉRITO SÓ NA CONCLUSÃO E NÃO SE COMPARA
    \hline
    \end{tabular}
